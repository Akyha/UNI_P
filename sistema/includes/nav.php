		<nav>
			...
			<ul>
				<li class="principal">
					<a href="#"><i class="fas fa-home"></i> Intro <span class="arrow"><i class="fas fa-angle-down"></i></span></a><ul>

					<a href="index.php"><i class="fas fa-angle-up"></i> Inicio</a>
			
				<!--<li><a href="login.php"><i class="fas fa-user-plus"></i> Chat</a></li>--><li><a href="contactanos.php"><i class="fas fa-user-plus"></i> Contactanos</a></li>
			</ul></li>
			...
			<?php } ?>
				...
				<li class="principal">
					...
					<ul>
						<li><a href="nueva_venta.php"><i class="far fa-file-alt"></i> Nueva Venta</a></li>
