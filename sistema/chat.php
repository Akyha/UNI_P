<?php
	...
	$pegaUser = BD::conn()->prepare("SELECT * FROM `usuarios` WHERE `correo` = ?");
...
<html lang="pt-BR">
	<head>
		<meta charset=UTF-8>
		<title>Chat servicio al cliente</title>
	...
	<body>
		...
		<h2>Bienvenido <?php echo $dadosUser['usuario'];?></h2>
		<!--<a href="?acao=sair">Salir</a>-->
		<input type="button" onclick=" location.href='index.php' " value="Salir" class="botao right" /> 
		...
		<aside id="users_online">
			...
			?>
				<li id="<?php echo $row['id'];?>">
					...
					<a href="#" id="<?php echo $_SESSION['id_user'].':'.$row['id'];?>" class="comecar"><?php echo utf8_encode($row['nombre']);?></a>
