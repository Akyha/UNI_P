...
//
    ...
    $('.delPhoto').click(function(){
       ...
       /*validacion actualizar foto en editar_producto*/
...
///////////////script buscar search/////////////

$('#search_proveedor').change(function(e){
    e.preventDefault();
    var sistema = getUrl();
    location.href = sistema='buscar_productos.php?proveedor='+$(this).val();
//iva sin punto y coma antes de funciones nueva venta    
 });

//////INICIO FUNCIONES NUEVA VENTA//////////
...
///////validar cantidad del producto antes de agregar - ventas////////
...
$('#frmChangePass').submit(function(e){
   ...
   if(passNuevo.length < 8 ){
       $('.alertChangePass').html('<p style="color: red;">La Nueva contraseña debe ser de 8 caracteres como minimo.</p>');
       $('.alertChangePass').slideDown();
       return false;
   }
      ...
      data: {action:action,noFactura:noFactura},
       ...
       success: function(response)
       {
        ...
        if(response == 'error'){
           ...
           $('#row_'+noFactura+' .div_factura').html('<button type="button" class="btn_anular inactive" ><i class="fas fa-ban"></li></button');
...
//function para proveedor select option
